class SortingRobot:
    ...
    def _insertion_sort(self):
        ...
        while self.can_move_right():
            ...
            # Element is smaller than all other sorted elements. Insert at front.
            if not self.light_is_on():
                self.swap_item()

            # shift all sorted elements to the right
    ...
    def _bubble_sort(self):
        ...
        ## Passes main tests
        # Failes stretch goal, too many swaps.
